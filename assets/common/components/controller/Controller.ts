...
export class Controller extends Component {
    ...
    private setupBtnEvent() {
        ...
        addBtnClickEvent(this.node, scriptName, this.audioBtn.getComponent(Button), this.onAudio);
        addBtnClickEvent(this.node, scriptName, this.recordBtn.getComponent(Button), this.onRecord);
        addBtnClickEvent(this.node, scriptName, this.favoritesBtn.getComponent(Button), this.onFavorites);
        addBtnClickEvent(this.node, scriptName, this.informationBtn.getComponent(Button), this.onInformation);

        addBtnClickEvent(this.node, scriptName, this.backBtn.getComponent(Button), this.onOption);
