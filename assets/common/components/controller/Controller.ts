...
export class Controller extends Component {
    ...
    private setupEventListen() {
        ...
        addBtnClickEvent(this.betPlusBtn, scriptName, this.betPlusBtn.getComponent(Button), this.changeBetClick, '1');
        addBtnClickEvent(this.betMinusBtn, scriptName, this.betMinusBtn.getComponent(Button), this.changeBetClick, '-1');

        Controller.changeBet.on(this.onChangeBet, this);
