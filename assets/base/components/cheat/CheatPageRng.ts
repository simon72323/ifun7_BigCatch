...
import { CheatCodeData } from '../../script/types/BaseType';
import { BaseRngItem } from './BaseRngItem';
...
export class CheatPageRng extends Component {
    ...
    onLoad() {
        ...
        for (let i: number = 0; i < 3; ++i) {
            ...
            toggleBtn.node.on(Button.EventType.CLICK, (v) => {
                this.selectModule(i);
            })
        }
        this.selectModule(0);

        editBox.node.on(EditBox.EventType.EDITING_DID_ENDED, (box) => {
