...
import { BaseLangBundleDir } from '../../script/types/BaseType';
...
export class AutoPage extends Component {
     ...
     */
    onLoad() {
        BundleLoader.onLoaded(BaseConst.BUNDLE_BASE_LANGUAGE, `${BaseDataManager.getInstance().urlParam.lang}/${BaseLangBundleDir.ui3_0}`, (LngRes: any) => {
