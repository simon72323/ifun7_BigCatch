...
import { BaseAnimationName, BaseLangBundleDir, TurboMode } from '../../script/types/BaseType';
...
export class Notice extends Component {
    ...
    onLoad() {
        ...
        BundleLoader.onLoaded(BaseConst.BUNDLE_BASE_LANGUAGE, `${BaseDataManager.getInstance().urlParam.lang}/${BaseLangBundleDir.ui3_0}`, (langRes: any) => {
            //多語系資源讀取完成後, 就不再使用系統字
