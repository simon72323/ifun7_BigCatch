import { _decorator, Component, Node, Label, Sprite, Button, tween, Vec3 } from 'cc';
import { NetworkManager } from '../Network/NetworkManager';
import { InGameMenuService, GameInfo } from '../Network/InGameMenuService';
import { IN_GAME_MENU_CONFIG } from '../Data/GameConfig';
...
export class InGameMenuController extends Component {
    ...
    onLoad() {
        ...
        this.inGameMenuService = this.networkManager.getInGameMenuService();
